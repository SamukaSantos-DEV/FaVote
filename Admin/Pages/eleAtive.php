...
<body>
    ...
    <main class="main-content">
        ...
        <a href="votacao.php" style="text-decoration: none;">
            <section class="main-vote">
                <div class="vote-box">
                    ...
                    <p>Votação para eleição do primeiro representante de sala da turma de 1º DSM Noturno</p><br>
                    <small>
        ...
        <section class="main-vote2">
            <div class="vote-box">
                <h1>REPRESENTANTE DE SALA<br>3º GPI (N)</h1>
                <p>Votação para eleição do primeiro representante de sala da turma de 3º GPI Noturno</p><br>
                <small>
                    <p><strong>Início:</strong> 05/05/2025 14:00 &nbsp; <strong>Fim:</strong> 11/05/2025 14:00</p>
                </small>
            </div>
            <div class="vote-img2">
                <img src="../Images/imgAlvo2.png" width="310">
            </div>
        ...
        <section class="main-vote2">
            <div class="vote-box">
                <h1>REPRESENTANTE DE SALA<br>2º DSM (N)</h1>
                <p>Votação para eleição do primeiro representante de sala da turma de 2º DSM Noturno</p><br>
                <small>
                    <p><strong>Início:</strong> 05/05/2025 14:00 &nbsp; <strong>Fim:</strong> 10/05/2025 14:00</p>
                </small>
            </div>
            <div class="vote-img3">
                <img src="../Images/imgAlvo2.png" width="310">
